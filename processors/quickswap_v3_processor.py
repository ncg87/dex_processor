...
class QuickswapV3Processor(BaseProcessor):
    def __init__(self):
        super().__init__('quickswap_v3')
        self.logger.info("Initialized QuickswapV3Processor...")
