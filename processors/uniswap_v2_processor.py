        ...
        try:
            ...
            for swap in swaps:
                swap_transaction = SwapEvent(
                    ...
                    amount0=swap['amount0In'] if float(swap['amount0In']) > 0 else float(swap['amount0Out']),
                    amount1=swap['amount1In'] if float(swap['amount1In']) > 0 else float(swap['amount1Out']),
